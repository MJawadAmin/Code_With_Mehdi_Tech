...
const ServicesData = [
  {
    imgSrc: "buyAHomeImage.png", // Replace with actual image path
    title: "Buy a Home",
    description:
...
const OurServices = () => {
  return (
    <> <div className=" text-center">
          <p className="normal_font text-blue-600">
          Our Services
    ...
    <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 p-6 px-80">
  ...
  {/* 2nd Main Div */}
  <div className="h-[30vh] py-32 flex justify-between px-72 bg-[rgb(226,239,255)] items-center">
